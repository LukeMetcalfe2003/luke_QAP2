...
function snake(value) {
  ...
  function mimeFromFilename(value) {
    ...
    console.log(mimeFromFilename('/User/Documents/readme.htm'));
    console.log(mimeFromFilename('/User/Documents/readme.css'));
    console.log(mimeFromFilename('/User/Documents/readme.js'));
    console.log(mimeFromFilename('/User/Documents/readme.jpg'));
    console.log(mimeFromFilename('/User/Documents/readme.jpeg'));
    console.log(mimeFromFilename('/User/Documents/readme.gif'));
    console.log(mimeFromFilename('/User/Documents/readme.bmp'));
    console.log(mimeFromFilename('/User/Documents/readme.ico'));
    console.log(mimeFromFilename('/User/Documents/readme.cur'));
    console.log(mimeFromFilename('/User/Documents/readme.png'));
    console.log(mimeFromFilename('/User/Documents/readme.svg'));
    console.log(mimeFromFilename('/User/Documents/readme.webp'));
    console.log(mimeFromFilename('/User/Documents/readme.mp3'));
    console.log(mimeFromFilename('/User/Documents/readme.wav'));
    console.log(mimeFromFilename('/User/Documents/readme.mp4'));
    console.log(mimeFromFilename('/User/Documents/readme.webm'));
    console.log(mimeFromFilename('/User/Documents/readme.json'));
    console.log(mimeFromFilename('/User/Documents/readme.mpeg'));
    console.log(mimeFromFilename('/User/Documents/readme.csv'));
    console.log(mimeFromFilename('/User/Documents/readme.ttf'));
    console.log(mimeFromFilename('/User/Documents/readme.woff'));
    console.log(mimeFromFilename('/User/Documents/readme.zip'));
  ...
  function generateLicenseLink(licenseCode, targetBlank) {
    ...
    let license = licenses[licenseCode];
    if (license) {
      let url = 'https://creativecommons.org/licenses/' + licenseCode.toLowerCase().replace('cc-', '') + '/4.0/';
      let link = '<a href="' + url + '"';
      if (targetBlank) {
        link += ' target="_blank"';
      }
    ...
    return '<a href="https://choosealicense.com/no-permission/" target="_blank">All Rights Reserved</a>';
  }
  ...
  function pureBool(value) {
    ...
    let trueValues = ['yes', 'y', 'oui', 'o', 't', 'true', 'vrai', 'v', '1'];
    let falseValues = ['no', 'non', 'n', 'f', 'false', 'faux', '0'];
  
    if (trueValues.includes(value.toString().toLowerCase())) {
      return true;
    }
  
    if (falseValues.includes(value.toString().toLowerCase())) {
      return false;
    }
  ...
  console.log(any('Y', 'yes', 1));
  console.log(any('Y', 'no', 1));
  console.log(any('Y', 'invalid', 1));
  ...
  function buildUrl(query, order, count, license) {
    ...
    let licenses = ['none', 'any', 'cc-by', 'cc-by-nc', 'cc-by-sa', 'cc-by-nd', 'cc-by-nc-sa', 'cc-by-nc-nd'];
    ...
    return 'https://api.inaturalist.org/v2/observations?query=' + encodeURIComponent(query) + '&count=' + count + '&order=' + order + '&license=' + license;
  }

  console.log(buildUrl('Monarch Butterfly', 'ascending', 25, 'cc-by'));
  console.log(buildUrl('Monarch Butterfly', 'ascending', 25, 'cc-by-nc'));
  console.log(buildUrl('Monarch Butterfly', 'ascending', 25, 'cc-by-sa'));
  console.log(buildUrl('Monarch Butterfly', 'ascending', 25, 'cc-by-nd'));
  console.log(buildUrl('Monarch Butterfly', 'ascending', 25, 'cc-by-nc-sa'));
  console.log(buildUrl('Monarch Butterfly', 'ascending', 25, 'cc-by-nc-nd'));
  console.log(buildUrl('Monarch Butterfly', 'ascending', 25, 'none'));
  console.log(buildUrl('Monarch Butterfly', 'ascending', 25, 'any'));
